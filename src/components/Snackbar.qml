...
Material.View {
    ...
    property color buttonColor: Material.Theme.accentColor
    property string text
    property bool opened
    property int duration: 2000
    property bool fullWidth: Material.Device.type === Material.Device.phone || Material.Device.type === Material.Device.phablet
    ...
    radius: fullWidth ? 0 : 2 * Material.Units.dp
    ...
    RowLayout {
        ...
        Material.Label {
            ...
            Layout.minimumWidth: snackbar.fullWidth ? -1 : 216 * Material.Units.dp - snackButton.width
            Layout.maximumWidth: snackbar.fullWidth ? -1 :
                Math.min(496 * Material.Units.dp - snackButton.width - middleSpacer.width - 48 * Material.Units.dp,
                         snackbar.parent.width - snackButton.width - middleSpacer.width - 48 * Material.Units.dp)

            Layout.preferredHeight: lineCount == 2 ? 80 * Material.Units.dp : 48 * Material.Units.dp
        ...
        Item {
            id: middleSpacer
            width: snackbar.buttonText == "" ? 0 : snackbar.fullWidth ? 24 * Material.Units.dp : 48 * Material.Units.dp
        }
