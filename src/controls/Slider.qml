...
Controls.Slider {
     ...
     */
    property int knobDiameter: 32 * Material.Units.dp
    ...
    implicitHeight: numericValueLabel ? 54 * Material.Units.dp : 32 * Material.Units.dp
    implicitWidth: 200 * Material.Units.dp
